...
class EmployeeServiceTest {
    ...
    void setUp() {
        ...
        employeeA = new Employee(1L, "EmployeeA", LocalDateTime.now().minusMonths(18).minusDays(1), "PositionA", 100, null);
        employeeB = new Employee(2L, "EmployeeB", LocalDateTime.now().minusMonths(18).plusDays(1), "PositionB", 1000, null);
    }
