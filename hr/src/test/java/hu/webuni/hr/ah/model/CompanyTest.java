...
class CompanyTest {
    ...
    @BeforeEach
    void setUp() {
        employeeA = new Employee(1, "EmployeeA", LocalDateTime.of(2020, 10, 10, 20, 20), "PositionA", 1000);
        employeeB = new Employee(2, "EmployeeB", LocalDateTime.of(2020, 10, 20, 10, 20), "PositionB", 1000);
    ...
    void testAddEmployee() {
        employeeC = new Employee(3, "EmployeeC", LocalDateTime.of(2020, 10, 20, 20, 10), "PositionC", 1000);
