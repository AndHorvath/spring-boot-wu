...
class CompanyServiceIT {
    ...
    void setUp() {
        ...
        company = new Company(1, "AA-11", "Company", "Address", null, List.of(employee));

        dummyEmployee = new Employee(0, "D", LocalDateTime.of(1, 1, 1, 1, 1), null, 1, null);
        dummyCompany = new Company(0, "DDDDD", "D", "D", null, List.of(dummyEmployee));
    }
    ...
    void testSaveCompany_ExistingRegistrationNumberDifferentId() {
        ...
        companyOfSameRegistrationNumber = new Company(2, company.getRegistrationNumber(), "C", "C", null, List.of());
    ...
    void testSaveCompany_ExistingRegistrationNumberIdenticalId() {
        clearAndSaveDummyCompanyForId(0);
        companyService.saveCompany(company);
        companyOfSameRegistrationNumber = new Company(1, company.getRegistrationNumber(), "C", "C", null, List.of());
    ...
    void testUpdateCompany_ExistingRegistrationNumberDifferentId() {
        clearAndSaveDummyCompanyForId(0);
        companyService.saveCompany(company);
        companyOfSameRegistrationNumber = new Company(0, company.getRegistrationNumber(), "C", "C", null, List.of());
